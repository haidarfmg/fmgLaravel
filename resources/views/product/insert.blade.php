...
@section('content')
    ...
    <form  action="insert" method="post">
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupFile02">price :</label>
            <input type="text" name="price" value="{{ old('price') }}" class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" id="inputGroupFile02">
        </div>
        <div class="input-group mb-3">
